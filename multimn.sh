...
# Author: LondiniumCryptoNew
# Source: https://github.com/LondiniumCryptoNew/Londinium-MultiMN-Script
...
function cmd_help() {
	echo -e "Options:\
			...
			\n**NOTE 2**: Check ${CYAN}https://github.com/londiniumcrypto/multimn/wiki/Commands${NC} for extended info and usage examples of each command.\
			\n**NOTE 3**: Check ${CYAN}https://github.com/londiniumcrypto/multimn/wiki/FAQs${NC} for technical questions and troubleshooting."
}
function cmd_update() {
	curl -sL https://raw.githubusercontent.com/londiniumcrypto/multimn/master/multimn_install.sh 3>&3 | bash
	exit
}
